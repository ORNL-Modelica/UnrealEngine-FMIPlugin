...
A MVP (minimally viable product) of simulating FMUs within the Unreal Engine environment. This MVP relies on the FMIKit repositorty (non-simulink portion) https://github.com/CATIA-Systems/FMIKit-Simulink.
